...
class KnowledgeCase(BaseModel):
    ...
    source_exception_id: int | None = Field(
        default=None, description="ID of the source exception if auto-generated"
    )
    source_type: SourceType = Field(description="How this case was created")
    verified: bool = Field(
        default=False, description="Whether this case has been verified by humans"
    )
...
class FlinkDocument(BaseModel):
    ...
    doc_url: str | None = Field(
        default=None, description="URL to the original document"
    )
